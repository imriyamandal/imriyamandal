...
### AI & Data Science Undergraduate · Machine Learning · Backend Development

<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=500&size=20&pause=1000&color=2EE6D6&center=true&vCenter=true&width=560&lines=AI+%26+Data+Science+Undergraduate;Machine+Learning+%7C+Predictive+Modeling;FastAPI+%7C+Streamlit+%7C+Python;Building+End-to-End+AI+Systems" alt="Typing SVG" />
...
[![Email](https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:riyamandal.email@gmail.com)
...
AI & Data Science undergraduate (B.Tech CSE, **CGPA: 9.62**) at Arka Jain University, with hands-on experience building end-to-end machine learning pipelines, REST APIs, and analytics dashboards. Former AI/ML Intern at **NIT Jamshedpur**, where I worked on a disease outbreak prediction and early-warning system — from data preprocessing and feature engineering through to model deployment.

- 🔬 Ex AI/ML Intern, National Institute of Technology (NIT) Jamshedpur
- 🧠 Focused on predictive modeling, feature engineering, and data-driven decision systems
- ⚙️ Comfortable across the full pipeline — data cleaning, model building, API development, and dashboarding
- 🎯 Open to AI/ML, Data Science, and Software Development internship opportunities
...
End-to-end AI healthcare surveillance platform. Dual-model architecture (XGBoost classifier + regressor) for outbreak classification and forecasting on epidemiological and time-series data, with a live Streamlit dashboard and FastAPI inference layer.
...
AI-powered course generator deployed on IBM Cloud, using IBM Cloud AI services to automatically create structured, contextually relevant learning content and course outlines.
